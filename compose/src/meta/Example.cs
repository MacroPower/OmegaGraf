...
namespace OmegaGraf.Compose.MetaData
{
    public static class Example
    {
        ...
        public static Input<Telegraf> Telegraf
        {
            get => new Input<Telegraf>()
            {
                BuildConfiguration = new BuildConfiguration()
                {
                    Image = "telegraf",
        ...
        public static DataSource GrafanaDataSource
        {
            get => new DataSource()
            {
                ID = 1,
